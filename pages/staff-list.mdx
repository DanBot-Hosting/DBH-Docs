...
<div align="center">
  ...
  `mikeyb3p0` | Co-Owner | | `devdibster` | Staff Manager + System Adminstrator | <!--| `flaringphoenix` |
  System Administrator |--> | `williamharrison` | Bot Administrator | |
  `.avixity` | Panel Administrator | | `fredd1e_` | Panel Administrator | |
  `kwitsies` | Administrator | | `jonfirexbox` | Administrator + Documentation Adminstrator| | `caliwyr` |
