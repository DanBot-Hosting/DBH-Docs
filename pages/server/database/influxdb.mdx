...
Once you have filled in all the fields, your database should be ready, for noSQL usage, kindly look at [InfluxDB's document page](https://docs.influxdata.com/influxdb/v2/)
