...
Hope we helped you! If you think that something is wrong, please consider [creating a PR in our repository.](https://github.com/DanBot-Hosting/Documentation/blob/main/docs/server/sharex.md)
