...
For a free server: 
<DiscordMessages>
  <DiscordMessage profile="dibster">`DBH!server create nodejs [optional server name]`</DiscordMessage>
</DiscordMessages>
<br></br>
For a donator server: 
<DiscordMessages>
  <DiscordMessage author="Donator User">`DBH!server create-donator nodejs [optional server name]`</DiscordMessage>
</DiscordMessages>
