...
For a free server: 
<DiscordMessages>
  <DiscordMessage profile="dibster">`DBH!server create redbot [optional server name]`</DiscordMessage>
  **Replace Name with your bot's name/the name you want you server to have**
</DiscordMessages>
<br></br>
For a donator server: 
<DiscordMessages>
  <DiscordMessage author="Donator User">`DBH!server create-donator redbot [optional server name]`</DiscordMessage>
  **Replace Name with your bot's name/the name you want you server to have**
</DiscordMessages>
