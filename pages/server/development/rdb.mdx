...
<DiscordMessages>
  <DiscordMessage
	...
	roleColor='#00cfff'
    roleName='Client'
	>DBH!server create redbot [optional server name]</DiscordMessage>
  <DiscordMessage 
  ...
  <DiscordEmbed slot="embeds" color="#00FF00">
	  <DiscordEmbedFields slot="fields">
        ...
        <DiscordEmbedField fieldTitle="__**Type**__">	redbot	</DiscordEmbedField>
	  </DiscordEmbedFields>
	</DiscordEmbed>
   </DiscordMessage>
</DiscordMessages>
...
<DiscordMessages>
  <DiscordMessage
	...
	>DBH!server create-donator redbot [optional server name]</DiscordMessage>
<DiscordMessage 
    author='DanBot Hosting'
	avatar='https://images-ext-1.discordapp.net/external/9j2_RacvCl8mly7hALccyH0PsM-tbJYm8twQKGf_3jY/https/cdn.discordapp.com/avatars/640161047671603205/718aa5783508125a02e3b244a1bf096e.png'
	roleColor='#0329d3'
