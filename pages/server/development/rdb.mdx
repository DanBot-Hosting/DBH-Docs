...
`DBH!server create reddiscordbot Name` - this is for the free node users.

**Replace Name with your bot's name/the name you want you server to have**

`DBH!server create-donator reddiscordbot Name` - this is for the premium/donator users.
