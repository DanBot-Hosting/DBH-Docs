  ...
  >
    <DiscordEmbed slot="embeds" color="#00FF00">
      <DiscordEmbedFields slot="fields">
        ...
        <DiscordEmbedField fieldTitle="__WARNING__">
          {" "}
          Please do not host game servers on java or AIO servers. If you need a
          gameserver, You need to use Dono-02 or Dono-04. Slots are 1$ for 2
          servers!{" "}
        </DiscordEmbedField>
      </DiscordEmbedFields>
    </DiscordEmbed>
