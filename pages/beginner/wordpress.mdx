...
<Redirect href="https://wordpress.org/download/" label="Download Wordpress" />

There you can download the **Wordpress** zip archive or you can just use [this link](https://wordpress.org/latest.zip) to its latest version.
