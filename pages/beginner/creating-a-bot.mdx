...
<Tip>
  We expect you to already know basics of coding.
</Tip>
...
<Tip label="Good To Know">
  You might need a cool profile picture for your bot so in order to get one click on an `App Icon` and upload the file.
</Tip>
...
<Tip>
  Sharing token is dangerous since it lets anyone else to connect to your bot. Each time you reset the token access to the previous one gets lost.
</Tip>
