...
This project was origally made by a bunch of DBH members to let newbies know everything about DanBot Hosting LTD! Which has now been contined by the DanBot Hosting LTD Staff Team.

### Credit
Head Maintainer: [Jonfirexbox](https://github.com/kyro3400)

Maintainer: [DIBSTER](https://github.com/DEV-DIBSTER) & [FC](https://github.com/FC5570)
...
<Tip>
  ...
  documentation is still being worked on and things are still changing. Want to contribute to this
